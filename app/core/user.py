...
fast_api_users = FastAPIUsers[User, int](get_user_manager, [auth_backend])
current_user = fast_api_users.current_user(active=True)
current_superuser = fast_api_users.current_user(active=True, superuser=True)
